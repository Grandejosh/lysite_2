<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="modalEditFormatStudent" tabindex="-1"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button wire:click="addTitlePartEdit" type="button" class="btn btn-primary mb-4">
                        <i class="fa fa-plus mr-1"></i>Titulo
                    </button>
                                ...
                                <li>
                                    @if ($part['id'])
                                        <div class="btn-group mr-3">
                                            <button
                                                onclick="addSubPartFormatJS({{ $k }},{{ $part['id'] }})"
                                                type="button" class="btn btn-secondary">
                                                <i class="fa fa-plus"></i>
                                            </button>
                                            <button onclick="deletePartStudentJS({{ $part['id'] }})" type="button"
                                                class="btn btn-secondary">
                                                <i class="fa fa-trash-alt"></i>
                                            </button>
                                        </div>
                                    @endif
                                    <a class="formattitleload" href="#" id="xformattitle{{ $k }}"
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click="updateFormatStudent" type="button" class="btn btn-primary">Guardar
                        Cambios</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function addSubPartFormatJS(k, id) {
            ...
            newLi.innerHTML = '<a class="formattitleload" href="#" id="xsubformattitle' + k + id +
