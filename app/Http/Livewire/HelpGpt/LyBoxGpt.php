        ...
        if (strlen($this->consulta) > 10) {
            ...
            if ($p_allowed > $p_used) {
                ...
                switch ($this->prompt) {
                    ...
                    case  0:
                        $consulta = "Parafraséame este texto en español como si fueras un experto en investigación, pero agrega cierta inconsistencia y errores gramaticales como lo haría un humano intenta no ser predecible: ";
                        break;
                    case  1:
    ...
    public function r_prompts($prompt)
    {
        ...
        switch ($prompt) {
            case 1:
                ...
                break;
            case 2:
                $this->message = "del ultimo archivo que subí  redáctame en un párrafo de 12 líneas el resumen de toda la investigación, manteniendo esta estructura: 1) Apellido y nombre de autor, 2) Año, 3) Título de la investigación, 4) Metodología, 5) Muestra y instrumentos de recolección, 6) Resultados, y 7) Conclusión general. " . $sufijo;
                break;
            case 3:
                $this->message = "del ultimo archivo que subí  Redáctame a profundidad la problemática de la investigación, si no lo dice explicitamente deducelo y dimelo. " . $sufijo;
                break;
            case 4:
                $this->message = "del ultimo archivo que subí  Redáctame las teorías de cada variable que se utilizaron en el apartado de marco teórico y/o revisión  de la literatura de esta investigación, y agregar a cada teoría su cita de autor, deducelo del documento si no está explicito " . $sufijo;
                break;
            case 5:
                $this->message = "del ultimo archivo que subí  Redáctame las definiciones más representativas de las variables de la investigación, y agrega su cita de autor a cada definición. si no lo dice explicitamente definelo del contenido. " . $sufijo;
                break;
            case 6:
                $this->message = "del ultimo archivo que subí  Cuál es el aporte principal de esta investigación, y quiénes serían los beneficiarios directos " . $sufijo;
                break;
            case 7:
                $this->message = "del ultimo archivo que subí  Indícame los resultados de acuerdo a cada objetivo de la investigación de este documento. Asimismo enfatízame los resultados estadísticos y numéricos de ser el caso. revisa todo el documento y dedúcelo si no es explícito. " . $sufijo;
                break;
            case 8:
                $this->message = "del ultimo archivo que subí  Redáctame la recomendación principal del documento, averigua en todo el documento antes de responder, no tiene que estár explicito en el documento " . $sufijo;
                break;
            case 9:
                $this->message = "del ultimo archivo que subí  Créame una propuesta de mejora en base a las recomendaciones de la investigación de este documento " . $sufijo;
                break;
            case 10:
                $this->message = "del ultimo archivo que subí  Resume lo más que puedas este documento de acuerdo a lo que consideres como elemental de una investigación, aunque el documento no sea una investigación resumelo. " . $sufijo;
                break;
            case 20:
