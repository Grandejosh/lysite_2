    ...
    <div class="row">
        <div class="col-md-12 d-flex justify-content-center align-items-center" style="padding: 40px 0px;">
            <div class="image-der mr-3">
                <img src="{{ asset('theme-lyontech/images/libro-m.png') }}" alt="Card image cap"
                        ...
                        <a href="{{ route('academic_students_my_course', $course->id) }}">
                            <div class="row">
                                ...
                                <div class="col-md-10" style="padding: 0px; margin-left: -10px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="mb-0">Videos:&nbsp;{{ $course->videos }}</h5>
                                            <h5 class="mt-0">Guías:&nbsp;&nbsp;&nbsp;{{ $course->archivos }}</h5>
                                        </div>
                                        <div class="col-md-4">
                                            <div wire:ignore.self>
                                                <div style="cursor: pointer" class="rating rating-24">
                                                    ...
                                                    @for ($i = 0; $i < $course->rating; $i++)
                                                        <div class="rating__item"><i class="material-icons"
                                                                value="{{ $i + 1 }}">star</i>
                                                        </div>
                                                    @endfor
                                                    ...
                                                    @for ($x = 0; $x < $course->empty; $x++)
                                                        <div class="rating__item" value="{{ $i }}"><i
                        ...
                        <a href="{{ route('academic_students_my_course', $course->id) }}">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="mb-0">Videos: 5 &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;Guías: 13
                                            </h5>
                                        </div>
                                        <div class="col-md-4">
                                            <div wire:ignore.self>
                                                <div style="cursor: pointer" class="rating rating-24">
                                                    ...
                                                    @for ($i = 0; $i < $course->rating; $i++)
                                                        <div class="rating__item"><i class="material-icons"
                                                                value="{{ $i + 1 }}">star</i></div>
                                                    @endfor

                                                    @if ($course->half)
                                                        <div class="rating__item"><i class="material-icons"
                                                                value="{{ $i }}">star_half</i></div>
                                                    @endif
