        ...
        <div class="container p-4">
          ...
          <div class="row my-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
              ...
              <div class="rounded-square bg-white shadow-1-strong d-flex align-items-center justify-content-center mb-4 mx-auto" style="width: 140px; height: 150px;">
                <img src="{{ ENV('APP_URL') }}/theme-lyontech/images/icon.jpg" height="150" alt=""
                     loading="lazy" />
              </div>LYONTEACH

              <p class="text-center">TU INVESTIGACIÓN MAS FACIL, AHORA.</p>
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
              <h5 class="text-uppercase mb-4 text-left">HERRAMIENTAS</h5>
            ...
            <!--Grid column-->
            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
              <h5 class="text-uppercase mb-4 text-left">Nosotros</h5>
            ...
            <!--Grid column-->
            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
              <h5 class="text-uppercase mb-4 text-left">Contacto</h5>
            ...
            <!--Grid column-->
             ...
             <!--Grid column-->
             <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                <h5 class="text-uppercase mb-4 text-left">Acceso</h5>
